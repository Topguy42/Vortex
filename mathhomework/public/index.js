...
document.addEventListener("DOMContentLoaded", () => {
	...
	// Prevent browser status bar from showing link hrefs on hover by removing href attributes
	// and making the elements act like buttons for accessibility (keyboard still works).
	[...document.querySelectorAll('.nav-tab, .quick-access-item, .game-item, .game-card, .app-card')].forEach((el) => {
		try {
			if (el.hasAttribute && el.hasAttribute('href')) el.removeAttribute('href');
